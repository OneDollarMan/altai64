...
class OperationsClient(object):
    ...
    def __init__(self, channel, client_config=operations_client_config.config):
        ...
        method_configs = google.api_core.gapic_v1.config.parse_method_configs(interface_config)
        ...
        self._delete_operation = google.api_core.gapic_v1.method.wrap_method(
    ...
    # Service calls
    def get_operation(
        self, name, retry=google.api_core.gapic_v1.method.DEFAULT, timeout=google.api_core.gapic_v1.method.DEFAULT
    ):
